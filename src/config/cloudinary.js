...
export const CLOUDINARY_DELIVERY_PROFILES = {
  ...
  // Full-bleed or card-shaped admin-uploaded imagery (Spin & Win background,
  // Scratch Card cover, etc.) — caps delivery width at 1080 (retina-sharp on
  // any phone) without forcing a crop, since admins upload arbitrary aspect
  // ratios; crop:'limit' only downscales, never upscales or distorts.
  capped1080: [{ ...DEFAULT_DELIVERY_TRANSFORM, width: 1080, crop: 'limit' }],
