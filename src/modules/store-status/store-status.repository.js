    ...
    const { rows } = await query(
      `UPDATE store_status
       SET manual_override_status = $1,
           manual_override_note = $2,
           manual_override_set_at = CASE WHEN $1 IS NULL THEN NULL ELSE NOW() END,
           manual_override_set_by = CASE WHEN $1 IS NULL THEN NULL ELSE $3 END,
           updated_at = NOW()
       RETURNING ${COLUMNS}`,
